...
TT_LPAREN   = 'Delim_Left Parenthesis'
TT_RPAREN   = 'Delim_Right Parenthesis'
TT_LCBRAC   = 'Delim_Left Curly Bracket'
TT_RCBRAC   = 'Delim_Right Curly Bracket'
TT_LSQBRAC  = 'Delim_Left Square Bracket'
TT_RSQBRAC  = 'Delim_Right Curly Bracket'
TT_COLON    = 'Delim_Colon'
TT_COMMA    = 'Delim_Comma'
TT_PERIOD   = 'Delim_Period'
TT_SEMICOL  = 'Delim_Semi Colon'
TT_UNSCO    = 'Delim_Underscore'
TT_SNGQ     = 'Delim_Single Quotation Mark'
TT_DBLQ     = 'Delim_Double Quotation Mark'
